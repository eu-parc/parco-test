 ...
 * [parco-test-module.yml](parco-test-module.yml)
     * Determines how your purl.obolibrary.org/obo/parco-test-module/ redirects will be handled
     ...
     * Paste in the contents of [parco-test-module.yml](parco-test-module.yml)
 ...
 * [parco-test-module.md](parco-test-module.md)
     ...
     * Paste in the contents of [parco-test-module.md](parco-test-module.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
